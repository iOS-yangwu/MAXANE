...
#define INIT_SDK    initializeSdk
#define SET_USER_CONTENT    setHasUserConsent
#define SET_IS_AGE_RESTRICT_USER    setIsAgeRestrictedUser

#pragma mark - interstitial
#define LOAD_INTERSTITIAL   loadInterstitial
#define SET_INTERSTITIAL_EXTRA_PARAMETER setInterstitialExtraParameter
#define ISREADY_INTERSTITIAL    isReadyInterstitial
